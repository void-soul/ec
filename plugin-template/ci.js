...
fs.writeFileSync('./dist/manifest.json', JSON.stringify(outInfo, null, 2), { encoding: 'utf-8' });
const index = fs.readFileSync('./dist/js/index.js', { encoding: 'utf-8' }).toString();
fs.writeFileSync('./dist/js/index.js', `${
...
(win, util) => new MyPlugin(win, util);`, { encoding: 'utf-8' });
shell.rm('-rf', './output/');
